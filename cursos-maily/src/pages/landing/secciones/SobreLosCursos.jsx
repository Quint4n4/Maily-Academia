...
const SobreLosCursos = () => (
  <section className="grid lg:min-h-[580px] lg:grid-cols-2">
    ...
    <div className="flex flex-col justify-center bg-academy-crema px-6 py-14 sm:px-10 lg:px-[88px] lg:py-0">
      <Eyebrow>{S.eyebrow}</Eyebrow>
      <h2 className="mt-6 font-display text-a-32 leading-[1.1] text-academy-tinta sm:text-a-46 lg:text-a-50">
        {S.titulo}
        <br />
        {S.tituloSegundaLinea}
      </h2>
      <p className="mt-6 max-w-[460px] font-ui text-a-17 leading-[1.7] text-academy-tinta-2">
        {S.texto}
      </p>
      <div className="mt-9">
